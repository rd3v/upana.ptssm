...
class Customer extends MY_Controller {
    ...
    public function kepuasan() {
        ...
        $this->load->view('hrd/kepuasan_pelanggan',$content);
    ...
    public function tambahdata() {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('hrd/customer_tambah',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('hrd/customer_edit',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function rincian($id) {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('hrd/customer_rincian',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function riwayat($customer_id) {
        ...
        if(!empty($resultCustomer)) {
            ...
            redirect(base_url()."hrd/customer");
        }

        if(!empty($resultHistory)) {
            $resultHistoryData = $resultHistory;
        } else {
            redirect(base_url()."hrd/customer/rincian/$customer_id");            
        }
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('hrd/customer_riwayat',$content);
        $this->load->view('footer',$footer);        
    }
