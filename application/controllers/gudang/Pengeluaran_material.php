...
class Pengeluaran_material extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('gudang/pengeluaran-material/main',$content);
    ...
    public function proses($tipe_spk, $id_spk, $id = '') {
        ...
        $this->load->view('header_menu2',$this->header);
        $this->load->view('gudang/pengeluaran-material/proses',$content);
        $this->load->view('footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('gudang/pengeluaran-material/edit',$content);
            $this->load->view('footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('gudang/pengeluaran-material/rincian',$content);
            $this->load->view('footer2',$footer);
        }
    }
    ...
    public function cetak($id) {
        ...
        if ($data) {
            ...
            $this->load->view('gudang/pengeluaran-material/print',$content);
        }
    }
