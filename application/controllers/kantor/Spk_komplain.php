...
class Spk_komplain extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('kantor/spk-komplain/main', ['new_id' => acak_id('data_spk_komplain', 'id')]);
    ...
    public function tambah() {
        ...
        $this->load->view('header_menu2',$this->header);
        $this->load->view('kantor/spk-komplain/tambah',$content);
        $this->load->view('footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('kantor/spk-komplain/edit',$content);
            $this->load->view('footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('kantor/spk-komplain/rincian',$content);
            $this->load->view('footer2',$footer);
        }
    }
