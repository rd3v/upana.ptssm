...
class Spk_survey extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('kantor/spk-survey/main', ['new_id' => acak_id('data_spk_survey', 'id')]);
    ...
    public function tambah() {
        ...
        $this->load->view('header_menu2',$this->header);
        $this->load->view('kantor/spk-survey/tambah',$content);
        $this->load->view('footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('kantor/spk-survey/edit',$content);
            $this->load->view('footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('header_menu2',$this->header);
            $this->load->view('kantor/spk-survey/rincian',$content);
            $this->load->view('footer2',$footer);
        }
    }
