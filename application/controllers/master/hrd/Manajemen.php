...
class Manajemen extends MY_Controller {
    ...
    public function user() {
        ...
        $this->load->view('master/hrd/manajemen_user',$content);
    ...
    public function tambahdata() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/hrd/customer_tambah',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/hrd/customer_edit',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function rincian($id) {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/hrd/customer_rincian',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function riwayat($customer_id) {
        ...
        if(!empty($resultHistory)) {
            ...
            redirect(base_url()."master/hrd/customer/rincian/$customer_id");            
        }
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/hrd/customer_riwayat',$content);
        $this->load->view('master/footer',$footer);        
    }
