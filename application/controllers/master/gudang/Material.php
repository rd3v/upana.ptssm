...
class Material extends MY_Controller {
    ...
    public function keluar() {
        ...
        $this->load->view('master/gudang/material_keluar',$content);
    ...
    public function tambahdata() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/gudang/customer_tambah',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/gudang/customer_edit',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function rincian($id) {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/gudang/customer_rincian',$content);
        $this->load->view('master/footer',$footer);        
    }
    ...
    public function riwayat($customer_id) {
        ...
        if(!empty($resultCustomer)) {
            ...
            redirect(base_url()."admin/gudang/customer");
        }

        if(!empty($resultHistory)) {
            $resultHistoryData = $resultHistory;
        } else {
            redirect(base_url()."admin/gudang/customer/rincian/$customer_id");            
        }
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/gudang/customer_riwayat',$content);
        $this->load->view('master/footer',$footer);        
    }
