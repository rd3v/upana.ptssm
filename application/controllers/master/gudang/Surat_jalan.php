...
class Surat_jalan extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('master/gudang/surat-jalan/main',$content);
    ...
    public function proses($id) {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/gudang/surat-jalan/proses',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function tambah() {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/gudang/surat-jalan/tambah',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/gudang/surat-jalan/edit',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/gudang/surat-jalan/rincian',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
    ...
    public function cetak($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/gudang/surat-jalan/print',$content);
        }
    }
