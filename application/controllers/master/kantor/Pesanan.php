...
class Pesanan extends MY_Controller {
    ...
    public function spk_pemasangan_index() {
        ...
        $this->load->view('master/kantor/pesanan_spk_pemasangan', ['new_id' => acak_id('data_spk_pemasangan', 'id')]);
    ...
    public function spk_pemasangan_tambah() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_pemasangan_tambah',$content);
    ...
    public function spk_pemasangan_edit($no_spk) {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_pemasangan_edit', $content);
        $this->load->view('master/footer',$footer);
    }
    ...
    public function spk_service_index() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_service');
        $this->load->view('master/footer',$footer);
    }
    ...
    public function spk_free_index() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_free');
        $this->load->view('master/footer',$footer);
    }
    ...
    public function spk_komplain_index() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_komplain');
        $this->load->view('master/footer',$footer);
    }
    ...
    public function spk_survey_index() {
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/pesanan_spk_survey');
        $this->load->view('master/footer',$footer);
    }
