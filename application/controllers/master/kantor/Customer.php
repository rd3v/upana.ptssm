...
class Customer extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('master/kantor/customer',$content);
    ...
    public function tambahdata() {
        ...
        $this->load->view('master/kantor/customer_tambah',$content);
    ...
    public function edit($id) {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/kantor/customer_edit',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function rincian($id) {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/kantor/customer_rincian',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function print_rincian_item($id) {
        ...
        $this->load->view('master/kantor/print_rincian_pelanggan_item',$content);
    }
    ...
    public function riwayat($customer_id) {
        ...
        if(!empty($resultHistory)) {
            ...
            redirect(base_url()."master/kantor/customer/rincian/$customer_id");
        }
        ...
        $this->load->view('master/header_menu',$this->header);
        $this->load->view('master/kantor/customer_riwayat',$content);
        $this->load->view('master/footer',$footer);
    }
