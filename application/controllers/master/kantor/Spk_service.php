...
class Spk_service extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('master/kantor/spk-service/main', ['new_id' => acak_id('data_spk_service', 'id')]);
    ...
    public function tambah() {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/kantor/spk-service/tambah',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-service/edit',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-service/rincian',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
