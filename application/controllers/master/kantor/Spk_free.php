...
class Spk_free extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('master/kantor/spk-free/main', ['new_id' => acak_id('data_spk_pemasangan', 'id')]);
    ...
    public function tambah() {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/kantor/spk-free/tambah',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-free/edit',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-free/rincian',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
