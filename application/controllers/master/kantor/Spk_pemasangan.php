...
class Spk_pemasangan extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('master/kantor/spk-pemasangan/main', ['new_id' => acak_id('data_spk_pemasangan', 'id')]);
    ...
    public function tambah() {
        ...
        $this->load->view('master/header_menu2',$this->header);
        $this->load->view('master/kantor/spk-pemasangan/tambah',$content);
        $this->load->view('master/footer2',$footer);
    }
    ...
    public function edit($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-pemasangan/edit',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
    ...
    public function rincian($id) {
        ...
        if ($data) {
            ...
            $this->load->view('master/header_menu2',$this->header);
            $this->load->view('master/kantor/spk-pemasangan/rincian',$content);
            $this->load->view('master/footer2',$footer);
        }
    }
