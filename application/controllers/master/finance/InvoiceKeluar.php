...
class InvoiceKeluar extends MY_Controller {
    ...
    public function barang_index() {
        ...
        $this->load->view('finance/invoice_keluar_barang',$content);
    ...
    public function material_index() {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('finance/invoice_keluar_material',$content);
        $this->load->view('footer',$footer);
    }
    ...
    public function tambahdata() {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('finance/customer_tambah',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('finance/customer_edit',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function rincian($id) {
        ...
        $this->load->view('header_menu',$this->header);
        $this->load->view('finance/customer_rincian',$content);
        $this->load->view('footer',$footer);        
    }
    ...
    public function riwayat($customer_id) {
        ...
        if(!empty($resultHistory)) {
            ...
            redirect(base_url()."finance/customer/rincian/$customer_id");            
        }
