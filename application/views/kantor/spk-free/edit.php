						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>kantor/spk-free" class="m-nav__link">
											<span class="m-nav__link-text">
												SPK Free
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>kantor/spk-free/edit/<?=$data['data']->id?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit
											</span>
										</a>
            ...
            $.post('<?=site_url('kantor/spk-free/submit-form')?>', {
                ...
                if (status == 'success') {
                    ...
                    if (result.success) {
                        ...
                        location.href='<?=site_url('kantor/spk-free')?>';
                    } else {
                        $('.btn-error-form').removeClass('btn-primary');
                        $('.btn-error-form').addClass('btn-danger');
