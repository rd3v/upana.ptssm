                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="<?=site_url('gudang/surat-jalan/edit/'.$data['data']->id)?>" class="m-nav__link">
                                            <span class="m-nav__link-text">
                                                Edit
                                            </span>
                                        </a>
                                    ...
                                    <form class="m-form m-form--fit m-form--label-align-right">
                                        <div class="m-portlet__body">
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control m-input" type="text" id="no_surat" value="<?=$data['data']->no_surat?>" />
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label  class="col-2 col-form-label">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    <input type="hidden" value="<?=$data['data']->id_spk?>" id="id_spk" />
                                                    <input class="form-control m-input" type="text" value="<?=($data['data']->id_spk ? $this->crud->gda('data_spk_pemasangan', ['id' => $data['data']->id_spk])['no_spk'] : '')?>" id="no_spk" disabled />
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label class="col-2 col-form-label">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    <select style="width: 100%" class="form-control m-select2 dropdown_search" id="id_pelanggan" onchange="set_pelanggan(this)" <?=($data['data']->id_spk ? 'disabled' : '')?>>
                                                        <option value=""></option>
                                                        <?php
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control m-input" type="text" id="kendaraan" value="<?=$data['data']->kendaraan?>">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label  class="col-2 col-form-label">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control m-input" type="text" id="nopol" value="<?=$data['data']->nopol?>">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label  class="col-2 col-form-label">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <option value="3" <?=($data['data']->status == '3' ? 'selected' : '')?>>Tidak Aktif (Batal)</option>
...
<?php foreach ($serial as $row2) { ?>
                                                    <option value="<?=$row2->id?>" <?=($id_serial[$i] == $row2->id ? 'selected' : '')?>><?=$row2->serial?></option>
<?php } ?>
                                                </select>
                                            </td>
                                            <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="hidden" id="id_surat" value="<?=$data['data']->id?>" />
