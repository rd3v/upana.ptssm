							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= base_url() ?>barang/masuk" class="m-nav__link">
											...
											<table class="table" id="tbl_list_barang_masuk">
												...
												<tbody>
													<tr>
														...
														<td>20</td>
														<td>
															<a href="proses_barang_masuk.html" class="btn btn-sm btn-success btn_material" style="color:white; width:80px;">proses</a>
														</td>
													</tr>
