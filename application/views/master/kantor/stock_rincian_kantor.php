							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= base_url() ?>admin/kantor/stock" class="m-nav__link">
									...
									<li class="m-nav__item">
										<a href="<?= base_url() ?>admin/kantor/stock/rincian/<?= $data->id ?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Rincian
											</span>
										</a>
											...
											<div class="m-portlet__head-title col-xl-12">
												<div style="margin-top: 20px" class=" row">
													...
													<div align="right" class="col-sm">
														<button onclick="window.location.href='<?= base_url() ?>admin/kantor/stock/rincian_barang/<?= $data->id ?>'" class="btn btn-primary">
															Rincian
														</button>
													</div>
												</div>
