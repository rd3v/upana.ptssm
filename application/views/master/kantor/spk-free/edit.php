						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-free" class="m-nav__link">
											<span class="m-nav__link-text">
												SPK Free
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-free/edit/<?=$data['data']->id?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit
											</span>
										</a>
						...
						<div class="row">
									...
									<form class="m-form m-form--fit m-form--label-align-right">
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-10">
													<input class="form-control m-input" type="date" value="<?=$data['data']->tanggal?>" id="tanggal">
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label  class="col-2 col-form-label">
							...
							<div class="m-portlet__body">
								...
								<div style="margin: 20px" align="right">
									<button data-toggle="modal" data-target="#form-modal" type="button" class="btn btn-success btn_free" onclick="modify_item('')"> + Tambah Item Pemasangan</button>
								</div>
								<table class="table">
									<thead>
										<tr>
...
<?php $i++; } ?>
								...
								<div align="center">
									<button type="button" class="btn btn-primary btn_free" onclick="submit_form()"> >> Simpan Data / Terbitkan >></button>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="hidden" id="id_spk" value="<?=$data['data']->id?>" />
	...
	<script>
        ...
        function submit_item() {
            ...
            $.post('<?=site_url('kantor/spk-free/submit-item')?>', {
                'id': '',
                'id_spk': $('#id_spk').val(),
                'kode': $('#item_kode').val(),
            ...
            swadel({
                preConfirm: function() {
                    return new Promise(function(resolve) {
                        $.post('<?=site_url('kantor/spk-free/delete-item')?>', {
                            'id': id
                        }, function(result, status) {
                            if (status == 'success') {
                                resolve(result);
        ...
        function submit_form() {
            ...
            $.post('<?=site_url('kantor/spk-free/submit-form')?>', {
            	'action': 'edit',
                'id': '<?=$data['data']->id?>',
                ...
                if (status == 'success') {
                    ...
                    if (result.success) {
                        ...
                        location.href='<?=site_url('master/kantor/spk-free')?>';
                    } else {
                        $('.btn-error-form').removeClass('btn-primary');
                        $('.btn-error-form').addClass('btn-danger');
