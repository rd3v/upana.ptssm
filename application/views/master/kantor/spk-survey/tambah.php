						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-survey" class="m-nav__link">
											<span class="m-nav__link-text">
												SPK Survey
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-survey/tambah?id=<?=$this->input->get('id', TRUE)?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Tambah
											</span>
										</a>
                    ...
                    $.post('<?=site_url('kantor/spk-survey/submit-form')?>', {
                        ...
                        if (status == 'success') {
                            ...
                            if (result.success) {
                                ...
                                location.href='<?=site_url('master/kantor/spk-survey')?>';
                            } else {
