						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-service/edit/<?=$data['data']->id?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit
											</span>
										</a>
									...
									<form class="m-form m-form--fit m-form--label-align-right">
										<div class="m-portlet__body">
                                            ...
                                            <div  class="form-group m-form__group row">
                                                ...
                                                <div class="col-10">
                                                    <textarea style="resize: none" class="form-control m-input " id="keterangan" name="keterangan" rows="3"><?=$data['data']->keterangan?></textarea>
                                                </div>
                                            </div>
        									<div class="form-group m-form__group row">
        										<label class="col-2 col-form-label">
                    ...
                    $.post('<?=site_url('kantor/spk-service/submit-form')?>', {
                        ...
                        if (status == 'success') {
                            ...
                            if (result.success) {
                                ...
                                location.href='<?=site_url('master/kantor/spk-service')?>';
                            } else {
