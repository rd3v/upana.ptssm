						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-pemasangan" class="m-nav__link">
											<span class="m-nav__link-text">
												SPK Pemasangan
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>master/kantor/spk-pemasangan/edit/<?=$data['data']->id?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit
											</span>
										</a>
            ...
            $.post('<?=site_url('kantor/spk-pemasangan/submit-form')?>', {
                ...
                if (status == 'success') {
                    ...
                    if (result.success) {
                        ...
                        location.href='<?=site_url('master/kantor/spk-pemasangan')?>';
                    } else {
                        $('.btn-error-form').removeClass('btn-primary');
                        $('.btn-error-form').addClass('btn-danger');
