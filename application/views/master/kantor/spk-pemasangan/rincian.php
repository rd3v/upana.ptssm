                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="<?= site_url() ?>master/kantor/spk-pemasangan/rincian/<?=$data['data']->id?>" class="m-nav__link">
                                            <span class="m-nav__link-text">
                                                Rincian
                                            </span>
                                        </a>
                            ...
                            <div class="col-xl-12">
                                <div class="m-portlet m-portlet--mobile">
                                    <div class="m-portlet__head header">
                                        ...
                                        <button onclick="window.open('<?= site_url() ?>master/kantor/spk-pemasangan/cetak/<?=$data['data']->id?>')" style="padding: 5px;width: 200px" class="btn btn-primary">
