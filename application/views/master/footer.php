...
<?php
			# FINANCE
			if($data['route'] == "admin/finance/invoice/masuk") { ?>
				...
				data: {
					saveState: {cookie: false},
				        ...
				        source: {
				          read: {
				            // sample GET method
				            method: 'POST',
				            url: '<?= base_url() ?>admin/finance/invoice/masuk/getdata',
				            map: function(raw) {
				              // sample data mapping
				              var dataSet = raw;
					...
					},
					{
						...
						template: function(row) {
							var btnrincian = "<a href='<?= base_url() ?>admin/finance/invoice/masuk/rincian/" + row.no_invoice + "' class='btn btn-sm btn-primary' style='color:white;' title='Rincian Data'><i class='fa fa-address-book-o'></i> Rincian</a> ";
							var btnedit = "<a href='<?= base_url() ?>admin/finance/invoice/masuk/edit/" + row.no_invoice + "' class='btn btn-sm btn-info ' tyle='color:white;' title='Edit Data'><i class='fa fa-pencil-square'></i> Edit</a> ";
					...
					$(document).on('click','.btnhapus',function() {
						...
						$.ajax({
							url:"<?= base_url() ?>admin/finance/invoice/masuk/hapus",
							type:"post",
							data:{
							...
							swal({
								...
								confirmButtonText: 'Ok'
									...
									if (result.value) {
										document.location = '<?= base_url() ?>admin/finance/invoice/masuk';
									}
								});
						}).fail(function(res) {
							console.log(res);
			...
			<?php }
				...
				if($data['route'] == "admin/finance/invoice/masuk/tambah") { ?>
					...
					$('#btn_simpan_data').click(function(e) {
						...
						if($("#no_invoice").val() == "") {
							...
							$.ajax({
								url:"<?= base_url() ?>admin/finance/invoice/masuk/tambahsubmit",
								type:"post",
								data:{
									// Invoice Masuk
					...
					$("select[name='nama_item']").on("change", function() {
						$.ajax({
							url:"<?= base_url() ?>admin/finance/invoice/masuk/getsatuan",
							type:"post",
							data:{
								kode:$(this).val(),
								field:"satuan"
				...
				if($data['route'] == "admin/finance/invoice/masuk/rincian/(:num)") { ?>
					$("li#invoice_masuk").addClass("m-menu__item--active");
					$("table#tbl_list_invoice_masuk tbody").html("");
				<?php }

				if($data['route'] == "admin/finance/invoice/keluar/barang") { ?>
				...
				if($data['route'] == "admin/finance/invoice/keluar/material") { ?>
					$("li#invoice_keluar").addClass("m-menu__item--submenu m-menu__item--open m-menu__item--expanded");
					$("li#invoice_keluar_material").addClass("m-menu__item--active");

				<?php }

				if($data['route'] == "admin/finance/penawaran") { ?>
					$("li#offer").addClass("m-menu__item--active");

				<?php }

				if($data['route'] == "admin/finance/stock") { ?>
				...
				data: {
			        ...
			        source: {
			          read: {
			            // sample GET method
			            method: 'POST',
			            url: '<?=site_url()?>admin/finance/stock/getdatakantor',
				...
				},
				{
					...
					textAlign: 'center',
					template:function(data) {
var html = "<a href='<?= base_url() ?>admin/finance/stock/rincian/"+data.kode+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
						return html;
					}
				}
				...
				data: {
			        ...
			        source: {
			          read: {
			            // sample GET method
			            method: 'POST',
			            url: '<?=site_url()?>admin/finance/stock/getdatatoko',
			            // url: '<?=site_url()?>finance/stock/getdatatoko',
			            map: function(raw) {
			              // sample data mapping
			              var dataSet = raw;
...
var html = "<a href='<?= base_url() ?>admin/finance/stock/rincian/"+data.kode+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
				...
				<?php } if($data['route'] == "admin/finance/stock/rincian/(:num)") { ?>
						$("li#stock").addClass("m-menu__item--active");
...
var tbl_rincian_stock = $('#tbl_rincian_stock').mDatatable({
				...
				<?php } if($data['route'] == "admin/finance/stock/rincian_barang/(:num)") { ?>
					$("li#stock").addClass("m-menu__item--active");
				...
				<?php } if($data['route'] == "admin/finance/price") { ?>
				...
				if($data['route'] == "admin/kantor/customer") { ?>
					...
					var tbl_list_pelanggan = $('#tbl_list_pelanggan').mDatatable({
						...
						},
						{
							field: 'aksi',
							template: function(row) {
								var html = "<a href='<?= base_url() ?>admin/kantor/customer/rincian/" + row.id + "' class='btn btn-sm btn-primary'  style='color:white;'><i class='fa fa-address-book-o'></i> Rincian</a> <a href='<?= base_url() ?>admin/kantor/customer/edit/" + row.id + "' class='btn btn-sm btn-info ' tyle='color:white;'><i class='fa fa-pencil-square'></i> Edit</a>";
								return html;
							},
							textAlign: "center"
						}
								...
								if (result.value) {
									...
									$.ajax({
										...
										swal(
											...
											document.location = "<?= base_url() ?>admin/kantor/customer";
										});
									}).fail(function(res) {
										console.log(res);
									});
			...
			var tbl_spk_pemasangan = $('#tbl_spk_pemasangan').mDatatable({
				...
				},
				{
					...
					textAlign: 'center',
					template: function(data) {
						var btnedit = "<a href='<?= site_url() ?>admin/kantor/order/spk-pemasangan/edit/"+data.no_spk+"' class='btn btn-sm btn-info' style='color:white; width:70px;'>Edit</a>";
							...
							if(res.state) {
								...
								swal({
									...
									confirmButtonText: 'Ok'
										...
										if (result.value) {
											document.location = '<?= site_url() ?>admin/kantor/order/spk-pemasangan';
										}
									});
				...
				$('#btn_buat_penawaran').click(function(e) {
					...
					if(data_tambah_item.length == 0) {
						...
						swal({
							...
							if (result.value) {
								$.ajax({
									url:"<?= site_url() ?>admin/kantor/penawaran/simpan",
									type:"post",
									data:data,
									cache:false
								}).done(function(res) {
		...
		jQuery(document).ready(function() {
			Select2.init();
				...
				},
				{
					...
					textAlign: 'center',
					template:function(data) {
var html = "<a href='<?= base_url() ?>admin/kantor/stock/rincian/"+data.id+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
						return html;
					}
				}
...
var html = "<a href='<?= base_url() ?>admin/kantor/stock/rincian/"+data.id+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
				...
				<?php } if($data['route'] == "admin/kantor/stock/rincian/(:any)") { ?>
					$("li#stock").addClass("m-menu__item--active");
...
var tbl_rincian_stock_keluar = $('#tbl_rincian_stock_keluar').mDatatable({
				...
				<?php } if($data['route'] == "admin/kantor/stock/rincian_barang/(:any)") { ?>
					$("li#stock").addClass("m-menu__item--active");
...
var tbl_rincian_stock = $('#tbl_rincian_stock').mDatatable({
			...
			var tbl_list_harga = $('#tbl_list_harga').mDatatable({
				...
				<?php } if($data['route'] == "admin/kantor/penawaran/rincian/(:any)") { ?>
					$("li#offer").addClass("m-menu__item--active");
  			    <?php }
			   ...
			   if($data['route'] == "master/hrd") { ?>
				...
				},
				{
					...
					textAlign: 'center',
					template: function(data) {
						var html = "<a href='<?= base_url() ?>admin/gudang/barang/masuk/proses/" + (data.id) + "' class='btn btn-sm btn-success btn_material' style='color:white;width:80px;'>proses</a>";
						return html;
					}
				}
				...
				<?php } if($data['route'] == "admin/gudang/barang/masuk/proses/(:any)") { ?>
					$("li#barang").addClass("m-menu__item--active");
					var serial = [];
								...
								$.ajax({
									...
									cache:false
										...
										swal({
											...
											document.location = "<?= base_url() ?>admin/gudang/barang/masuk";
										});
				...
				<?php } if($data['route'] == "admin/gudang/inventory/tambah") { ?>
					$("li#inventory").addClass("m-menu__item--active");		
				...
				<?php } if($data['route'] == "admin/gudang/inventory/edit/(:any)") { ?>
					$("li#inventory").addClass("m-menu__item--active");
				...
				},
				{
					...
					textAlign: 'center',
					template:function(data) {
var html = "<a href='<?= base_url() ?>admin/gudang/stock/rincian/"+data.id+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
						return html;
					}
				}
...
var html = "<a href='<?= base_url() ?>admin/gudang/stock/rincian/"+data.id+"' class=\"btn btn-sm btn-primary\" style=\"color:white; width:80px;\">Rincian</a>";
				...
				<?php } if($data['route'] == "admin/gudang/stock/rincian/(:any)") { ?>
						$("li#stock-manajemen").addClass("m-menu__item--active");
...
var tbl_rincian_stock_keluar = $('#tbl_rincian_stock_keluar').mDatatable({
				...
				<?php } if($data['route'] == "admin/gudang/stock/rincian_barang/(:any)") { ?>
						$("li#stock-manajemen").addClass("m-menu__item--active");
...
var tbl_rincian_stock = $('#tbl_rincian_stock').mDatatable({
				...
				<?php } if($data['route'] == "admin/gudang/stock/master") { ?>
					...
					$(document).on('click','.btnhapus',function() {
						...
						$.ajax({
							url:"<?= base_url() ?>admin/gudang/stock/master/hapus",
							type:"post",
							data:{
								kode:kode
							},
