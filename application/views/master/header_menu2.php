								...
								switch($data['user']['accesstype']) {
									...
									<div class="m-menu__submenu " style="">
											...
											<div class="m-menu__submenu " style="">
												...
												<ul class="m-menu__subnav">
													...
													<li id="spk-pemasangan" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>master/kantor/spk-pemasangan" class="m-menu__link ">
													...
													<li id="spk-service" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>master/kantor/spk-service"  class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
													...
													<li id="spk-free" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>master/kantor/spk-free"  class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
													...
													<li id="spk-komplain" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>master/kantor/spk-komplain"  class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
													...
													<li id="spk-survey" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>master/kantor/spk-survey"  class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
										...
										<li id="offer" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/kantor/penawaran" class="m-menu__link ">
										...
										<li id="stock" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/kantor/stock" class="m-menu__link ">
										...
										<li id="price" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/kantor/price" class="m-menu__link ">
									...
									<div class="m-menu__submenu " style="">
										...
										<li id="invoice_masuk" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/finance/invoice/masuk" class="m-menu__link ">
											...
											<div class="m-menu__submenu " style="">
												...
												<ul class="m-menu__subnav">
													...
													<li id="invoice_keluar_barang" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>admin/finance/invoice/keluar/barang" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
													...
													<li id="invoice_keluar_material" class="m-menu__item " aria-haspopup="true">
														<a href="<?= base_url() ?>admin/finance/invoice/keluar/material"  class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
										...
										<!-- Management Stock -->
										<li id="stock" class="m-menu__item  " aria-haspopup="true" >
											<a href="<?= base_url() ?>admin/finance/stock" class="m-menu__link ">
												<i class="m-menu__link-icon  flaticon-open-box"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
										...
										<!-- Manajemen Harga -->
										<li id="price" class="m-menu__item" aria-haspopup="true" >
											<a href="<?= base_url() ?>admin/finance/price" class="m-menu__link ">
												<i class="m-menu__link-icon la la-list"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
								...
								<li id="order" class="m-menu__item m-menu__item--submenu" aria-haspopup="true" data-menu-submenu-toggle="hover">
									...
									<div class="m-menu__submenu " style="">
										...
										<li id="barang" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/gudang/barang/masuk" class="m-menu__link ">
										...
										<li id="surat" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>master/gudang/surat-jalan" class="m-menu__link ">
										...
										<li id="material" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>master/gudang/pengeluaran-material" class="m-menu__link ">
										...
										<li id="inventory" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/gudang/inventory" class="m-menu__link ">
												<i class="m-menu__link-icon fa fa-cube"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
										...
										<li id="stock-manajemen" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/gudang/stock/manajemen" class="m-menu__link ">
												<i class="m-menu__link-icon flaticon-list-1"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
										...
										<li id="stock-master" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>admin/gudang/stock/master" class="m-menu__link ">
												<i class="m-menu__link-icon flaticon-open-box"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
								...
								<li id="order" class="m-menu__item m-menu__item--submenu" aria-haspopup="true" data-menu-submenu-toggle="hover">
									...
									<div class="m-menu__submenu " style="">
										...
										<li id="manajemen-penugasan" class="m-menu__item" aria-haspopup="true" >
											<a href="<?= base_url() ?>master/hrd" class="m-menu__link ">
										...
										<li id="kepuasan-pelanggan" class="m-menu__item" aria-haspopup="true" >
											<a  href="<?= base_url() ?>master/hrd/kepuasan-pelanggan" class="m-menu__link ">
										...
										<li id="manajemen-user" class="m-menu__item  " aria-haspopup="true" >
											<a  href="<?= base_url() ?>master/hrd/manajemen/user" class="m-menu__link ">
												<i class="m-menu__link-icon fa 		fa-user-o"></i>
												<span class="m-menu__link-title">
													<span class="m-menu__link-wrap">
														<span class="m-menu__link-text">
