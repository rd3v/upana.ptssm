							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= base_url() ?>admin/gudang/inventory" class="m-nav__link">
					...
					<div class="m-content">
						<div class="row">
							<div class="col-xl-12">
								...
								<button onclick="window.location.href = '<?= site_url() ?>admin/gudang/inventory/tambah';" type="button" class="btn btn-success btn_tambah_spk">Tambah Item Inventory</button>
																			</div>
																		</div>
								...
								<span>
									...
									for ($i=0; $i < count($data['inventory']['tersedia']); $i++) { ?>
											<tr>
												...
												<td>
													<a target="_blank" href="<?= site_url() ?>admin/gudang/inventory/barcode/<?= $data['inventory']['tersedia'][$i]['no_seri'] ?>" class="btn btn-sm btn-secondary btn_print_barcode"  style="color:black; width:40px;">
														<i class="fa fa-barcode"></i>
													</a>
													<a href="<?= site_url() ?>admin/gudang/inventory/edit/<?= $data['inventory']['tersedia'][$i]['id'] ?>" class="btn btn-sm btn-secondary"  style="color:black; width:40px;">
