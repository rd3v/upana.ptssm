						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="<?= site_url() ?>admin/gudang/inventory/edit/<?= $data->id ?>" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit
											</span>
										</a>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="m-portlet m-portlet--tab">
									...
									<!--begin::Form-->
									<form action="<?= site_url() ?>admin/gudang/inventory/update" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right" method="post" id="edit_inventory">
