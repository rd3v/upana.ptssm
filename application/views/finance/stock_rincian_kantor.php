							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									<li class="m-nav__item m-nav__item--home">
										<a href="<?= base_url() ?>finance" class="m-nav__link m-nav__link--icon">
											...
											<div class="m-portlet__head-title col-xl-12">
												<div style="margin-top: 20px" class=" row">
													...
													<div align="right" class="col-sm">
														<button onclick="window.location.href='<?= base_url() ?>finance/stock/rincian_barang/<?= $data->id ?>'" class="btn btn-primary">
															Rincian
														</button>
													</div>
												</div>
