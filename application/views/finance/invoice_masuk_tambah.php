								...
								<div class="m-portlet m-portlet--tab">
									<div class="input_invoice_barang">
										...
										<form class="m-form m-form--fit m-form--label-align-right">
											<div class="m-portlet__body">
												<div class="form-group m-form__group row">
													...
													<div class="col-10">
														<input class="form-control m-input" type="text" value="" id="no_invoice">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<label class="col-2 col-form-label">
													...
													<div class="col-10">
														<input class="form-control m-input" type="date" value="" id="tanggal_pembuatan_invoice">
													</div>
												</div>
												...
												<div class="form-group m-form__group row">
													...
													<div class="col-10">
														<input class="form-control m-input" type="text" value="" id="nama_supplier">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<label  class="col-2 col-form-label">
													...
													<div class="col-10">
														<input class="form-control m-input" type="tel" value="" id="no_telpon">
													</div>
												</div>
												<div class="form-group m-form__group row">
													...
													<div class="col-10">
														<input class="form-control m-input" type="email" value="" id="email_supplier">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<label  class="col-2 col-form-label">
													...
													<div class="col-10">
														<input class="form-control m-input" type="text" value="" id="alamat_supplier">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<label  class="col-2 col-form-label">
													...
													<div class="col-10">
														<input class="form-control m-input" type="text" value="" id="npwp_supplier">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<label  class="col-2 col-form-label">
										...
										<div class="m-portlet__body">
											...
											<table class="better_table" id="tbl_list_invoice_masuk" >
												<thead>
													<tr>
														<th>No</th>
														<th>Nama </th>
											...
											<table style="width: 100%" class="tg">
												<tr>
													...
													<th style="width: 15%" class="tg-s268">126,635,000</th>
												</tr>
												<tr>
													<th style="width: 10%" class="tg-s268"></th>
													<th style="width: 10%" class="tg-s268"></th>
													...
													<th style="width: 15%" class="tg-s268">12,663,500</th>
												</tr>
												<tr>
													<th style="width: 10%" class="tg-s268"></th>
													<th style="width: 10%" class="tg-s268"></th>
													...
													<th style="width: 15%" class="tg-s268">139,298,500</th>
												</tr>
											</table>
											<!--end: Datatable -->
											<div align="center">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group m-form__group row">
								...
								<div class="col-9">
									<input class="form-control m-input" type="text" value="11.73" id="harga_item">
								</div>
							</div>
							<div class="form-group m-form__group row">
								<label  class="col-3 col-form-label">
